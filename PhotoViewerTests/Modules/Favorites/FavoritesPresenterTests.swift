...
class FavoritesPresenterTests: XCTestCase {
  ...
  override func setUp() {
    super.setUp()
    sup = FavoritesPresenterImpl(favoritesInteractor: mockInteractor, favoritesRouter: mockRouter)
    mockPhotos = [
  ...
  func testGetPhotoByID_OK() {
    mockInteractor.mockPhotos = mockPhotos
    mockInteractor.favoritesID.value = [15286, 624015, 572897]
    sup?.getPhotoByID(photoID: 15286) { result in
  ...
  func testGetPhotoByID_NotOK() {
    mockInteractor.mockPhotos = mockPhotos
    mockInteractor.favoritesID.value = [15286, 624015, 572897]
    sup?.getPhotoByID(photoID: 1) { result in
      XCTAssertNil(result)
    }
  }
  ...
  func testGetFavoritesPhotos_OK() {
    mockInteractor.mockPhotos = mockPhotos
    mockInteractor.favoritesID.value = [15286, 624015, 572897, 9999]
    sup?.setInteractorIDsObserver()
  ...
  func testGetFavoritesPhotos_NotOK_getPhotoByID_FailureClosure() {
    ...
    mockInteractor.favoritesID.value = [15286, 624015, 572897, 0]
    sup?.setInteractorIDsObserver()
  ...
  func testGetFavoritesPhotos_NotOK_getPhotoByID_FailureClosure2() {
    ...
    mockInteractor.favoritesID.value = [0, 624015, 572897, 9999]
    sup?.setInteractorIDsObserver()
  ...
  func testGetPhotoUrl_NotOK_URLError() {
    mockInteractor.mockPhotos = mockPhotos
    mockInteractor.favoritesID.value = [9999]
    sup?.setInteractorIDsObserver()
